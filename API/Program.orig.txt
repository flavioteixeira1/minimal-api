...
app.MapPost("/administradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
{
    ...
    {
        validacao.Mensagens.Add("Precisa estar vinculado aum perfil");
    }
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    {
        validacao.Mensagens.Add("A marca não pode ficar embranco");
    }

    if (veiculoDTO.Ano < 20)
    {
        validacao.Mensagens.Add("Ano de fabricação inválido");
    }
